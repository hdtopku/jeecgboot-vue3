<template>
  <a-card size="small">
    ...
    <Search showTop showBottom @init-query="initQuery" @confirm-copy="confirmCopy" placeholder="粘贴或模糊搜索激活码、用户标识">
      <template #suffix>
        <a-button class="animate__animated animate__heartBeat animate__slower animate__repeat-3" @click="clickHelp" type="link" danger>帮助</a-button>
      </template>
    </Search>
